"""Test utility to open the DVD/CD tray on Windows.

This small helper exposes the same functionality as the original
`test-dvd-open.py` but lives in `scripts/` and uses a more consistent name.
"""
